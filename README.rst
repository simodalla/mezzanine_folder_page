...
Mezzanine Folder Page is `Mezzanine`_ module for add new content type named
FolderPage.

Dependencies
============

Mezzanine Folder Page required:

* `Mezzanine`_ 1.4+, 3.+

This software is in an absolute development status.

License
=======
Mezzanine Page Folder is `BSD licensed`_.
